...
namespace TeamSkunk
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc(option => option.Filters.Add(new RequireHttpsAttribute()))
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                AppId = Configuration["Authentication:Discord:AppId"],
                AppSecret = Configuration["Authentication:Discord:AppSecret"],
