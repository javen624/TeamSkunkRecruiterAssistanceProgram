...
using TeamSkunk.ViewModels.ManageViewModels;
...
namespace TeamSkunk.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> ChangeDisplayName(ChangeDisplayNameViewModel model)
        {
            ...
            if (user != null)
            {
                var result = await _userManager.SetUserNameAsync(user, model.NewDisplayName);
                if (result.Succeeded)
                {
                    await _signInManager.SignInAsync(user, isPersistent: false);
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            else if (_userManager.FindByIdAsync(user.Id) != null)
            {
