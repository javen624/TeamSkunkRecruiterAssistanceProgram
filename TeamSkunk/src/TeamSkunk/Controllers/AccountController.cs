...
using TeamSkunk.ViewModels.AccountViewModels;
...
namespace TeamSkunk.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        {
            List<SelectionVM> roleSelectionVMs = EnumToSelectList(typeof(Roles));
            ViewData["Roles"] = roleSelectionVMs;
        }
